    ...
    <el-card style="width: 500px; margin: 100px auto" >
      <el-form  :model="form" :rules="rules" label-width="120px"  ref="waterForm" size="small" style="width: 80%; margin: 0 auto">
        ...
        <el-form-item label="简介" prop="jianjie">
          <el-input type="textarea" v-model="form.jianjie" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="save">确 定</el-button>
          <el-button @click="no" style="margin-left: 50px">取 消</el-button>
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        date: [
          {required: true, message: '请输入建成时间', trigger: 'blur'}
        ],
        fuze: [
